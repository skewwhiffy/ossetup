...
yay -Syu --noconfirm dropbox rtl88xxau-aircrack-dkms-git spotblock-git wkhtmltopdf-static
...
sudo pacman -Syu --noconfirm xclip code flatpak zsh keepassxc mame maven curl wget conky the_silver_searcher
sudo pacman -Syu --noconfirm noto-fonts noto-fonts-cjk noto-fonts-emoji noto-fonts-extra fzf

echo Installing some flatpaks
flatpak install -y flathub com.spotify.Client us.zoom.Zoom io.dbeaver.DBeaverCommunity com.getpostman.Postman
